...
def print_death_age(people_dict):
    ...
    for person_key in people_dict:
        ...
        print(f'{name} Born: {birth_year} Died {death_year} Death Age: {death_age}')
...
def print_marriages(marriages_dict, people_dict):
    ...
    for marriage_key in marriages_dict:
        ...
        wife_key = marriage[1]
        marriage_year = marriage[2]
        husband_name = people_dict[husband_key][0]
        husband_age = marriage_year - people_dict[husband_key][2]
        wife_name = people_dict[wife_key][0]
        wife_age = marriage_year - people_dict[wife_key][2]
        print(f'{husband_name} {husband_age} > {marriage_year} < {wife_name} {wife_age}')
...
def count_marriages(people_dict, marriages_dict):
    for person_key in people_dict:
        ...
        for marriage_key in marriages_dict:
            marriage = marriages_dict[marriage_key]
            times_married = 0
            if person_key == marriage[0]:
                name = person[0]
                times_married +=1
            elif person_key == marriage[1]:
                name = person[0]
                times_married +=1
        print(f'{name} has been married {times_married}')
